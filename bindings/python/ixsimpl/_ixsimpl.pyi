...
class Expr:
    ...
    @property
    def add_coeff(self) -> Expr: ...
    @property
    def add_nterms(self) -> int: ...
    def add_term(self, i: int) -> Expr: ...
    def add_term_coeff(self, i: int) -> Expr: ...
    @property
    def mul_coeff(self) -> Expr: ...
    @property
    def mul_nfactors(self) -> int: ...
    def mul_factor_base(self, i: int) -> Expr: ...
    def mul_factor_exp(self, i: int) -> int: ...
    @property
    def pw_ncases(self) -> int: ...
    def pw_value(self, i: int) -> Expr: ...
    def pw_cond(self, i: int) -> Expr: ...
    @property
    def cmp_op(self) -> int: ...
    ...
    @overload
    def subs(self, mapping: dict[str | Expr, Expr | int]) -> Expr: ...
