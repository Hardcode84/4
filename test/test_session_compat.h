...
#define ixs_check_integer_valued(ctx, expr, assumptions, n_assumptions)        \
  IXS_TEST_WITH_CTX((ctx), (ixs_check_integer_valued)(IXS_TEST_SESSION(ctx),   \
                                                      (expr), (assumptions),   \
                                                      (n_assumptions)))
#define ixs_check_defined(ctx, expr, assumptions, n_assumptions)               \
  IXS_TEST_WITH_CTX((ctx),                                                     \
                    (ixs_check_defined)(IXS_TEST_SESSION(ctx), (expr),         \
                                        (assumptions), (n_assumptions)))
...
#define ixs_integer_range(ctx, expr, assumptions, n_assumptions, out)          \
  IXS_TEST_WITH_CTX((ctx), (ixs_integer_range)(IXS_TEST_SESSION(ctx), (expr),  \
                                               (assumptions), (n_assumptions), \
                                               (out)))
#define ixs_facts_create(ctx)                                                  \
  IXS_TEST_WITH_CTX((ctx), (ixs_facts_create)(IXS_TEST_SESSION(ctx)))
