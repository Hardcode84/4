...
/*
 * These regressions fabricate invalid nodes via raw constructors. Those
 * helpers are internal and disappear in the amalgamated build, so keep the
 * checks on the normal multi-translation-unit path only.
 */
